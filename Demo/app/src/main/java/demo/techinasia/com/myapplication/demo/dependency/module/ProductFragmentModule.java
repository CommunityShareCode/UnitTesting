...
import demo.techinasia.com.myapplication.demo.dependency.component.ProductFragmentSubComponent;
...
public abstract class ProductFragmentModule {
    ...
    abstract AndroidInjector.Factory<? extends Fragment> bindFragmentInjectorFactory(ProductFragmentSubComponent.Builder builder);
