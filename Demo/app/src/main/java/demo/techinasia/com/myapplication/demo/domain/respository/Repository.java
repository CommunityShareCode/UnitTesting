package demo.techinasia.com.myapplication.demo.domain.respository;
...
public interface Repository<T, E extends Model> {

    T getRequest(E request) throws IOException;
