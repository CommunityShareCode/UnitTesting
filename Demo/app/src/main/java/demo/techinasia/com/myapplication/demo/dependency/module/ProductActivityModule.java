...
import demo.techinasia.com.myapplication.demo.dependency.component.ProductActivitySubComponent;
 ...
 */
@Module(subcomponents = ProductActivitySubComponent.class)
public abstract class ProductActivityModule {

    @Binds
    @IntoMap
    @ActivityKey(ProductActivity.class)
    abstract AndroidInjector.Factory<? extends Activity> bindActivityInjectorFactory(ProductActivitySubComponent.Builder builder);
